...
class UnitTests(unittest.TestCase):
    def test_kmeans(self):
        ...
        spu_fn = spsim.sim_jax(sim, proc, copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_kmeans
        result = spu_fn(x1, x2)
        try:
            if result == "skipped":
                return True
    ...
    def test_kmeans_kmeans_plus_plus(self):
        ...
        spu_fn = spsim.sim_jax(sim, proc, copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_kmeans_kmeans_plus_plus
        result = spu_fn(X)
        try:
            if result == "skipped":
                return True
    ...
    def test_kmeans_init_array(self):
        ...
        spu_fn = spsim.sim_jax(sim, proc, copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_kmeans_init_array
    ...
    def test_kmeans_random(self):
        ...
        spu_fn = spsim.sim_jax(sim, proc, copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_kmeans_random
        result = spu_fn(X)
        try:
            if result == "skipped":
                return True
