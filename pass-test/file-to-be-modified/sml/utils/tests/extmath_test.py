...
class ExtMathTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        sim64 = spsim.Simulator({partynum}, config64)
        sim128 = spsim.Simulator({partynum}, config128)
        ...
        for test_i, mat in enumerate(data_pack):
            if test_i == 0:
                self._svd_test_main(
                    ...
                    vec_rtol=vec_rtol,
                    test_i=test_i,
                    pphlo_list = {pphlo_dict}{skip_control} #test_svd_0
                )
                ...
                self._svd_test_main(
                    ...
                    vec_rtol=vec_rtol,
                    test_i=test_i,
                    pphlo_list = {pphlo_dict}{skip_control} #test_svd_1
                )
            elif test_i == 2:
                self._svd_test_main(
                    mat / scale,
                    ...
                    vec_rtol=vec_rtol,
                    test_i=test_i,
                    pphlo_list = {pphlo_dict}{skip_control} #test_svd_2
                )
