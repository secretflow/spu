...
class UnitTests(unittest.TestCase):
    def test_knn(self):
        ...
        spu_fn_uniform = spsim.sim_jax(sim, proc_predict, static_argnums=(3, 4, 5), copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_knn_uniform
        ...
        spu_fn_distance = spsim.sim_jax(sim, proc_predict, static_argnums=(3, 4, 5), copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_knn_distance
