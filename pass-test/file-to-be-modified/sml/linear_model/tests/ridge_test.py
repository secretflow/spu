    ...
    def test_ridge(self):
        ...
        for i in range(len(solver_list)):
            ...
            if solver == "svd":
                ...
                spu_fn = spsim.sim_jax(sim, proc, static_argnums=(3,), copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_ridge_svd
            else:
                proc.__name__ = f"test_ridge_cholesky"
                spu_fn = spsim.sim_jax(sim, proc, static_argnums=(3,), copts=copts, pphlo_ref={pphlo_dict}{skip_control}) #test_ridge_cholesky
