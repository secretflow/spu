...
sim = spsim.Simulator.simple({partynum}, spu_pb2.ProtocolKind.{protocalchosen}, spu_pb2.FieldType.FM128)
...
class TestGeneralizedLinearRegressor(unittest.TestCase):
    ...
    def test_ncSolver_encrypted(self):
        ...
        proc_test(proc_ncSolver, X, y, pphlo_ref={pphlo_dict}{skip_control}) #proc_ncSolver
    ...
    def test_Poisson_encrypted(self):
        ...
        proc_test(proc_Poisson, X, round_exp_y, pphlo_ref={pphlo_dict}{skip_control}) #proc_Poisson
    ...
    def test_gamma_encrypted(self):
        ...
        proc_test(proc_Gamma, X, exp_y, pphlo_ref={pphlo_dict}{skip_control}) #proc_Gamma
    ...
    def test_Tweedie_encrypted(self):
        ...
        proc_test(proc_Tweedie, X, exp_y, pphlo_ref={pphlo_dict}{skip_control}) #proc_Tweedie
