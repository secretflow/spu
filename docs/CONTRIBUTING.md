...
|              |                                                                                                                  |
| :----------- | :--------------------------------------------------------------------------------------------------------------- |
| Source texts | [**getting_started/install**.rst](getting_started/install.rst)                                                   |
| Translations | [locales/zh_CN/LC_MESSAGES/**getting_started/install**.po](locales/zh_CN/LC_MESSAGES/getting_started/install.po) |
...
>
> <figure>
>   <img src="imgs/CONTRIBUTING/poedit.png" alt="screenshot of Poedit">
> </figure>
...
[reference/py_api.rst](reference/py_api.rst) documents SPU's Python API.
...
|      |                                                                                                                  |
| :--- | :--------------------------------------------------------------------------------------------------------------- |
| 原文 | [**getting_started/install**.rst](getting_started/install.rst)                                                   |
| 翻译 | [locales/zh_CN/LC_MESSAGES/**getting_started/install**.po](locales/zh_CN/LC_MESSAGES/getting_started/install.po) |
...
[reference/py_api.rst](reference/py_api.rst) 包含 SPU Python API 的文档。
