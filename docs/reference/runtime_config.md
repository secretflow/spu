...
| reveal_secret_condition | [ bool](#bool) | Allow runtime to reveal `secret variable` use as while condition result, debug purpose only. |
| reveal_secret_indices | [ bool](#bool) | Allow runtime to reveal `secret variable` use as indices, debug purpose only. |
