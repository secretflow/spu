...
class UnitTests(unittest.TestCase):
    def test_simple(self):
        ...
        # Test fit_transform
        def proc_transform(X_train, y_train, X_test, n_classes, n_neighbors=5, weights='uniform'):
            knn_model = KNN()
        ...
        # 运行模拟器
        result = spsim.sim_jax(sim, proc_transform,  static_argnums=(3,4))(X_train, y_train_new, X_test, n_classes, 3)
