...
TYPED_TEST(ShapeOpsUnaryTest, Transpose) {
  ...
  // WHAT
  auto transpose_wrapper = [](SPUContext* ctx, const MemRef& x) {
...
TYPED_TEST(ShapeOpsUnaryTest, BroadcastTo) {
  ...
  auto broadcast_to_wrapper = [](SPUContext* ctx, const MemRef& in) {
...
TYPED_TEST(ShapeOpsUnaryTest, BroadcastInDims) {
  ...
  auto broadcast_to_wrapper = [](SPUContext* ctx, const MemRef& in) {
    return broadcast_to(ctx, in, {4, 2}, {1});
  };
...
TEST(SliceTest, Slice) {
  ...
  auto slice_wrapper = [](SPUContext* ctx, const MemRef& in) {
    return slice(ctx, in, {2, 1}, {2, 2}, {});
  };
...
TEST(SliceTest, InsertSlice) {
  // GIVEN
  xt::xarray<int32_t> x = {{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
  xt::xarray<int32_t> y = {{0, 1}, {3, 4}};
  using P_VT = public_v::type;

  auto update_slice_wrapper = [](SPUContext* ctx, const MemRef& in,
                                 const MemRef& update) {
    return insert_slice(ctx, in, update, {1, 1}, {1, 1}, false);
  };
  auto z =
...
TEST(ReshapeTest, Reshape) {
  ...
  auto reshape_wrapper = [](SPUContext* ctx, const MemRef& in) {
...
TEST(ShapeOpsUnaryTest, Reverse) {
  ...
  auto reverse_wrapper = [](SPUContext* ctx, const MemRef& in) {
...
TEST(ShapeOpsUnaryTest, BroadcastAfterReshape) {
  ...
  using P_VT = public_v::type;
  auto pad_wrapper = [](SPUContext* ctx, const MemRef& in) {
...
TEST(ShapeOpsUnaryTest, Pad) {
  ...
  using P_VT = public_v::type;
  auto pad_wrapper = [](SPUContext* ctx, const MemRef& in) {
    return pad(ctx, in, test::makeMemRef(ctx, 35, P_VT()), {1, 0, 0, 0},
               {0, 2, 0, 0}, {2, 1, 0, 0});
  };
...
TEST(ShapeOpsUnaryTest, InteriorPadding) {
  ...
  using P_VT = public_v::type;
  auto pad_wrapper = [](SPUContext* ctx, const MemRef& in) {
    return pad(ctx, in, test::makeMemRef(ctx, 0, P_VT()), {0, 0}, {0, 0},
               {1, 1});
  };
...
TYPED_TEST(ConcatTest, Concatenate) {
  ...
  auto concat_wrapper = [](SPUContext* ctx, const MemRef& lhs,
                           const MemRef& rhs) {
