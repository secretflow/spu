...
#define SPU_UNIMPL YACL_THROW("Unimpl")
...
template <>
struct formatter<spu::SemanticType> : ostream_formatter {};

template <>
struct formatter<spu::StorageType> : ostream_formatter {};
...
template <>
struct formatter<spu::BeaverType> : ostream_formatter {};

template <>
struct formatter<spu::ExpMode> : ostream_formatter {};

template <>
struct formatter<spu::LogMode> : ostream_formatter {};

template <>
struct formatter<spu::SigmoidMode> : ostream_formatter {};
