...
class IoClientTest : public ::testing::TestWithParam<
                         std::tuple<size_t, ProtocolKind, size_t, Visibility>> {
};
...
TEST_P(IoClientTest, Float) {
  ...
  RuntimeConfig hconf;
  ProtocolConfig pconf;
  pconf.set_kind(std::get<1>(GetParam()));
  pconf.set_field(std::get<2>(GetParam()));
  *hconf.mutable_protocol() = std::move(pconf);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(4, 3, 2),
                     ...
                     testing::Values(Visibility::VIS_PUBLIC,
...
//     testing::Combine(testing::Values(3), testing::Values(ProtocolKind::ABY3),
//                      testing::Values(32, 64, 128),
//                      testing::Values(Visibility::VIS_PUBLIC,
//                                      Visibility::VIS_SECRET)),
//     [](const testing::TestParamInfo<IoClientTest::ParamType> &p) {
...
//   RuntimeConfig hconf;
//   ProtocolConfig pconf;
//   pconf.set_kind(ProtocolKind::SEMI2K);
//   pconf.set_field(64);
//   *hconf.mutable_protocol() = std::move(pconf);
//   hconf.set_ring_width(64);
