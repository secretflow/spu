...
TEST(ArithShareTy, Simple) {
  registerTypes();
  {
    ...
    EXPECT_EQ(ty.toString(), "securenn.ArithShare<SE_I32,32>");
...
TEST(BoolShareTy, Simple) {
  // Securenn::BShr constructor with field.
  {
    ...
    EXPECT_EQ(ty.toString(), "securenn.BoolShare<SE_I128,ST_128,128>");
  ...
  // Securenn::BShr constructor with field and nbits.
  {
    ...
    EXPECT_EQ(ty.toString(), "securenn.BoolShare<SE_I128,ST_128,7>");
