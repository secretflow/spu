...
RuntimeConfig makeConfig(FieldType field) {
  RuntimeConfig conf;
  conf.set_protocol(ProtocolKind::ALKAID);
...
INSTANTIATE_TEST_SUITE_P(
    AlkaidBoolean, ApiTest,
    testing::Combine(testing::Values(makeAlkaidBooleanProtocol),              //
