...
TEST(AShrTy, Simple) {
  registerTypes();
  {
    ...
    EXPECT_EQ(ty.toString(), "alkaid_boolean.AShr<FM32>");
...
TEST(BShrTy, Simple) {
  ...
  // alkaid_boolean::BShr constructor with field and nbits.
  {
    ...
    EXPECT_EQ(ty.toString(), "alkaid_boolean.BShr<PT_U8,7>");
    ...
    EXPECT_EQ(cty.toString(), "alkaid_boolean.BShr<PT_U8,7>");
  }
}
