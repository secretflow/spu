...
class BasicOTProtocols {
 public:
  ...
  std::shared_ptr<YaclFerretOT> GetSenderCOT() { return ferret_sender_; }

  std::shared_ptr<YaclFerretOT> GetReceiverCOT() { return ferret_receiver_; }
 ...
 private:
  ...
  std::shared_ptr<YaclFerretOT> ferret_sender_;
  std::shared_ptr<YaclFerretOT> ferret_receiver_;
};
