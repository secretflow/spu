...
class Beaver {
 public:
  ...
  virtual Triple Mul(size_t field, int64_t size, ReplayDesc* x_desc = nullptr,
                     ReplayDesc* y_desc = nullptr) = 0;

  virtual Triple And(int64_t size /*in bytes*/) = 0;

  virtual Triple Dot(size_t field, int64_t m, int64_t n, int64_t k,
  ...
  virtual Pair Trunc(size_t field, int64_t size, size_t bits) = 0;
  ...
  virtual Triple TruncPr(size_t field, int64_t size, size_t bits) = 0;

  virtual Array RandBit(size_t field, int64_t size) = 0;
  ...
  */
  virtual Pair PermPair(size_t field, int64_t size, size_t perm_rank,
  ...
  virtual Pair Eqz(size_t field, int64_t size) = 0;
};
