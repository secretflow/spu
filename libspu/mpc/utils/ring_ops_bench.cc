...
// static MemRef makeRandomArray(size_t field, int64_t numel, int64_t
// stride) {
//   const Type ty = makeType<RingTy>(PT_I64, field);
//   const size_t buf_size = SizeOf(field) * numel * stride;
//   auto buf = std::make_shared<yacl::Buffer>(buf_size);
//   const int64_t offset = 0;
//   return MemRef(buf, ty, {numel}, {stride}, offset);
// }
...
//   const auto field = static_cast<size_t>(state.range(2));
