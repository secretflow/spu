...
func.func @main(%arg0: tensor<16x!pphlo.secret<f32>>, %arg1: tensor<16x10000x!pphlo.secret<f32>>) -> (tensor<16x10000x!pphlo.secret<f32>>) {
    ...
    //CHECK: return %2
    %0 = "pphlo.broadcast"(%arg0) {broadcast_dimensions = array<i64:0>} : (tensor<16x!pphlo.secret<f32>>) -> tensor<16x10000x!pphlo.secret<f32>>
    %1 = "pphlo.divide"(%arg1, %0) : (tensor<16x10000x!pphlo.secret<f32>>, tensor<16x10000x!pphlo.secret<f32>>) -> tensor<16x10000x!pphlo.secret<f32>>
