// RUN: pphlo-opt --partial-sort-to-topk --split-input-file %s | FileCheck %s

func.func @main(%arg0: tensor<12x2x!pphlo.secret<i32>>) -> tensor<2x!pphlo.secret<f32>> {
    // CHECK: pphlo.custom_call @mhlo.topk(%10) {mhlo.attributes = {k = 5 : i64, k_hi = 7 : i64, largest = true, value_only = true}} : (tensor<2x12x!pphlo.secret<f32>>) -> tensor<2x7x!pphlo.secret<f32>>
    %0 = pphlo.constant dense<5.000000e-01> : tensor<1x2xf32>
    %1 = pphlo.constant dense<0x7FC00000> : tensor<12x2xf32>
...
func.func @main(%arg0: tensor<12x!pphlo.secret<i32>>) -> tensor<!pphlo.secret<f32>> {
    //CHECK: %10 = pphlo.custom_call @mhlo.topk(%9) {mhlo.attributes = {k = 5 : i64, k_hi = 7 : i64, largest = true, value_only = true}} : (tensor<12x!pphlo.secret<f32>>) -> tensor<7x!pphlo.secret<f32>>
    %0 = pphlo.constant dense<0x7FC00000> : tensor<12xf32>
    %1 = pphlo.constant dense<5.000000e-01> : tensor<1xf32>
    %2 = pphlo.constant dense<false> : tensor<i1>
...
func.func @main(%arg0: tensor<14x2x!pphlo.secret<i32>>) -> tensor<2x!pphlo.secret<f32>> {
    // CHECK: pphlo.custom_call @mhlo.topk(%10) {mhlo.attributes = {k = 5 : i64, k_hi = 7 : i64, largest = true, value_only = true}} : (tensor<2x14x!pphlo.secret<f32>>) -> tensor<2x7x!pphlo.secret<f32>>
    %0 = pphlo.constant dense<5.000000e-01> : tensor<1x2xf32>
    %1 = pphlo.constant dense<0x7FC00000> : tensor<14x2xf32>
    %2 = pphlo.constant dense<false> : tensor<i1>
...
func.func @main(%arg0: tensor<14x!pphlo.secret<i32>>) -> tensor<!pphlo.secret<f32>> {
    //CHECK: %10 = pphlo.custom_call @mhlo.topk(%9) {mhlo.attributes = {k = 5 : i64, k_hi = 7 : i64, largest = true, value_only = true}} : (tensor<14x!pphlo.secret<f32>>) -> tensor<7x!pphlo.secret<f32>>
    %0 = pphlo.constant dense<0x7FC00000> : tensor<14xf32>
    %1 = pphlo.constant dense<5.000000e-01> : tensor<1xf32>
    %2 = pphlo.constant dense<false> : tensor<i1>
