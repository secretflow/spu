...
func.func @main() -> tensor<i32> {
  %2 = arith.constant dense<[0x41DA6E5887800000, 0x41C94E3940000000, 0x41C4BD2007000000, 0x41DC95133AC00000, 0x41D1650CEC000000, 0x41C9DF42E7800000, 0x41D46C43B6800000, 0x41C467EE0E800000, 0x41DC705F14400000]> : tensor<9xf64>
  ...
  %51 = arith.constant dense<5> : tensor<i32>
...
func.func @main() -> tensor<i32> {
  %0 = arith.constant dense<[0.000000e+00, -3.40282347E+38]> : tensor<2xf32>
...
func.func @main() -> tensor<i32> {
    %0 = arith.constant dense<-1.7976931344453863E+308> : tensor<1x1xf64>
    ...
    %3 = arith.constant dense<5> : tensor<i32>
