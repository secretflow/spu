...
func.func @main(%arg0: tensor<1024x1xf32>, %arg1: tensor<1024x1xf32>) -> (tensor<1024xf32>, tensor<1024xf32>) {
    ...
    // CHECK: %0 = pphlo.convert %cst : (tensor<f32>) -> tensor<!pphlo.secret<f32>>
    // CHECK: %1 = pphlo.convert %cst : (tensor<f32>) -> tensor<!pphlo.secret<f32>>
    // CHECK: %2:2 = pphlo.reduce(%arg0 init: %0), (%arg1 init: %1) across dimensions = [1] : (tensor<1024x1x!pphlo.secret<f32>>, tensor<1024x1x!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>) -> (tensor<1024x!pphlo.secret<f32>>, tensor<1024x!pphlo.secret<f32>>)
    ...
    // CHECK:        %3 = pphlo.add %arg2, %arg4 : tensor<!pphlo.secret<f32>>
    // CHECK:        %4 = pphlo.add %arg3, %arg5 : tensor<!pphlo.secret<f32>>
    // CHECK:        pphlo.return %3, %4 : tensor<!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>
    // CHECK: }
