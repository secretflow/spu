...
func.func @main(%arg1: tensor<1024x1xf32>) -> (tensor<1024xf32>) {
    ...
    // CHECK: %0 = pphlo.reduce(%arg0 init: %cst) applies pphlo.add across dimensions = [1] : (tensor<1024x1xf32>, tensor<f32>) -> tensor<1024xf32>
...
func.func @main(%arg0: tensor<3x2xi64>) -> tensor<2x2xi64>   {
  ...
  // CHECK: %0 = pphlo.pad %arg0, %cst, low = [2, 0], high = [1, 0], interior = [1, 0] : (tensor<3x2xi64>, tensor<i64>) -> tensor<8x2xi64>
  // CHECK: %1 = "pphlo.reduce_window"(%0, %cst)
