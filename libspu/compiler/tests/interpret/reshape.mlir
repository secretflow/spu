...
func.func @reshape_op_test_i32_i32_p() {
   %0 = arith.constant dense<[[1,2,3,4,5,6]]> : tensor<1x6xi32>
   %1 = pphlo.reshape %0 : (tensor<1x6xi32>)->tensor<6xi32>
   %2 = arith.constant dense<[1, 2, 3, 4, 5, 6]> : tensor<6xi32>
...
func.func @reshape_op_test_i32_i32_s() {
   ...
   %3 = arith.constant dense<[1, 2, 3, 4, 5, 6]> : tensor<6xi32>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<6xi32>, tensor<6x!pphlo.secret<i32>>)->()
   func.return
}
...
func.func @reshape_op_test_i32_i32_p() {
   %0 = arith.constant dense<[1,2,3,4,5,6]> : tensor<6xi32>
   %1 = pphlo.reshape %0 : (tensor<6xi32>)->tensor<2x3xi32>
   %2 = arith.constant dense<[[1, 2, 3], [4, 5, 6]]> : tensor<2x3xi32>
...
func.func @reshape_op_test_i32_i32_s() {
   ...
   %3 = arith.constant dense<[[1, 2, 3], [4, 5, 6]]> : tensor<2x3xi32>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<2x3xi32>, tensor<2x3x!pphlo.secret<i32>>)->()
   func.return
}
...
func.func @reshape_op_test_i32_i32_p() {
   %0 = arith.constant dense<[[1,2,3],[4,5,6]]> : tensor<2x3xi32>
   %1 = pphlo.reshape %0 : (tensor<2x3xi32>)->tensor<3x2xi32>
   %2 = arith.constant dense<[[1, 2], [3, 4], [5, 6]]> : tensor<3x2xi32>
...
func.func @reshape_op_test_i32_i32_s() {
   ...
   %3 = arith.constant dense<[[1, 2], [3, 4], [5, 6]]> : tensor<3x2xi32>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<3x2xi32>, tensor<3x2x!pphlo.secret<i32>>)->()
   func.return
}
...
func.func @reshape_op_test_i32_i32_p() {
   %0 = arith.constant dense<[[1,2],[3,4],[5,6]]> : tensor<3x2xi32>
