...
func.func @xor_op_test_i8_i8_pp() {
   ...
   %3 = arith.constant dense<[127, -1, 0]> : tensor<3xi8>
...
func.func @xor_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<[127, -1, 0]> : tensor<3xi8>
...
func.func @xor_op_test_ui8_ui8_ss() {
   ...
   %5 = arith.constant dense<[255, 128, 0]> : tensor<3xui8>
...
func.func @xor_op_test_i16_i16_pp() {
   ...
   %3 = arith.constant dense<[32767, -1, 0]> : tensor<3xi16>
...
func.func @xor_op_test_i16_i16_ss() {
   ...
   %5 = arith.constant dense<[32767, -1, 0]> : tensor<3xi16>
...
func.func @xor_op_test_ui16_ui16_ss() {
   ...
   %5 = arith.constant dense<[65535, 32768, 0]> : tensor<3xui16>
...
func.func @xor_op_test_i32_i32_pp() {
   ...
   %3 = arith.constant dense<[2147483647, -1, 0]> : tensor<3xi32>
...
func.func @xor_op_test_i32_i32_ss() {
   ...
   %5 = arith.constant dense<[2147483647, -1, 0]> : tensor<3xi32>
...
func.func @xor_op_test_ui32_ui32_ss() {
   ...
   %5 = arith.constant dense<[4294967295, 2147483648, 0]> : tensor<3xui32>
...
func.func @xor_op_test_i64_i64_pp() {
   ...
   %3 = arith.constant dense<[9223372036854775807, -1, 0]> : tensor<3xi64>
...
func.func @xor_op_test_i64_i64_ss() {
   ...
   %5 = arith.constant dense<[9223372036854775807, -1, 0]> : tensor<3xi64>
...
func.func @xor_op_test_ui64_ui64_ss() {
   ...
   %5 = arith.constant dense<[18446744073709551615, 9223372036854775808, 0]> : tensor<3xui64>
