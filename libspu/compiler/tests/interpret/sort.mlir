...
func.func @sort_stable() {
  %input0 = arith.constant dense<[[1, 2, 3], [3, 2, 1]]> : tensor<2x3xi64>
  %input1 = arith.constant dense<[[3, 2, 1], [1, 2, 3]]> : tensor<2x3xi64>
  ...
  %expected0 = arith.constant dense<[[3, 2, 3], [1, 2, 1]]> : tensor<2x3xi64>
  %expected1 = arith.constant dense<[[1, 2, 1], [3, 2, 3]]> : tensor<2x3xi64>
