...
func.func @multiply_op_test_i8_i8_pp() {
   ...
   %3 = arith.constant dense<[0, -1, 64, 81, 0]> : tensor<5xi8>
...
func.func @multiply_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<[0, -1, 64, 81, 0]> : tensor<5xi8>
...
func.func @multiply_op_test_ui8_ui8_pp() {
   %0 = arith.constant dense<[0, 16, 16]> : tensor<3xui8>
   %1 = arith.constant dense<[255, 16, 17]> : tensor<3xui8>
   %2 = pphlo.multiply %0,%1 : (tensor<3xui8>,tensor<3xui8>)->tensor<3xui8>
   %3 = arith.constant dense<[0, 0, 16]> : tensor<3xui8>
...
func.func @multiply_op_test_ui8_ui8_ss() {
   ...
   %5 = arith.constant dense<[0, 0, 16]> : tensor<3xui8>
...
func.func @multiply_op_test_i16_i16_pp() {
   ...
   %3 = arith.constant dense<[0, -1, 16384, 16641, 0]> : tensor<5xi16>
...
func.func @multiply_op_test_i16_i16_ss() {
   ...
   %5 = arith.constant dense<[0, -1, 16384, 16641, 0]> : tensor<5xi16>
...
func.func @multiply_op_test_ui16_ui16_pp() {
   ...
   %3 = arith.constant dense<[0, 0]> : tensor<2xui16>
...
func.func @multiply_op_test_ui16_ui16_ss() {
   ...
   %5 = arith.constant dense<[0, 0]> : tensor<2xui16>
...
func.func @multiply_op_test_i32_i32_pp() {
   ...
   %3 = arith.constant dense<[0, -1, 1073741824, 1073807361, 0]> : tensor<5xi32>
...
func.func @multiply_op_test_i32_i32_ss() {
   ...
   %5 = arith.constant dense<[0, -1, 1073741824, 1073807361, 0]> : tensor<5xi32>
...
func.func @multiply_op_test_ui32_ui32_pp() {
   ...
   %3 = arith.constant dense<[0, 0]> : tensor<2xui32>
...
func.func @multiply_op_test_ui32_ui32_ss() {
   ...
   %5 = arith.constant dense<[0, 0]> : tensor<2xui32>
...
func.func @multiply_op_test_i64_i64_pp() {
   ...
   %3 = arith.constant dense<[0, -1, 4611686018427387904, 4611686022722355201, 0]> : tensor<5xi64>
...
func.func @multiply_op_test_i64_i64_ss() {
   ...
   %5 = arith.constant dense<[0, -1, 4611686018427387904, 4611686022722355201, 0]> : tensor<5xi64>
...
func.func @multiply_op_test_ui64_ui64_pp() {
   ...
   %3 = arith.constant dense<[0, 0]> : tensor<2xui64>
...
func.func @multiply_op_test_ui64_ui64_ss() {
   ...
   %5 = arith.constant dense<[0, 0]> : tensor<2xui64>
...
func.func @multiply_op_test_f16_f16_pp() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 7.000000e+00, 9.375000e-02, 2.999880e-02, 9.867180e+00]> : tensor<5xf16>
...
func.func @multiply_op_test_f16_f16_ss() {
   ...
   %5 = arith.constant dense<[0.000000e+00, 7.000000e+00, 9.375000e-02, 2.999880e-02, 9.867180e+00]> : tensor<5xf16>
...
func.func @multiply_op_test_f32_f32_pp() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 7.000000e+00, 9.375000e-02, 0.0300000012, 9.86960506]> : tensor<5xf32>
...
func.func @multiply_op_test_f32_f32_ss() {
   ...
   %5 = arith.constant dense<[0.000000e+00, 7.000000e+00, 9.375000e-02, 0.0300000012, 9.86960506]> : tensor<5xf32>
...
func.func @multiply_op_test_f64_f64_pp() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 7.000000e+00, 9.375000e-02, 3.000000e-02, 9.869604401089358]> : tensor<5xf64>
...
func.func @multiply_op_test_f64_f64_ss() {
   ...
   %5 = arith.constant dense<[0.000000e+00, 7.000000e+00, 9.375000e-02, 3.000000e-02, 9.869604401089358]> : tensor<5xf64>
