...
func.func @case_negative_index_default() {
  %index = arith.constant dense<-1> : tensor<i32>
  %result_branch0 = arith.constant dense<0> : tensor<2xi64>
  %result_branch1 = arith.constant dense<1> : tensor<2xi64>
  ...
  %expected = arith.constant dense<[1, 1]> : tensor<2xi64>
...
func.func @case_in_bound_index() {
  %index = arith.constant dense<0> : tensor<i32>
  %result_branch0 = arith.constant dense<0> : tensor<2xi64>
  %result_branch1 = arith.constant dense<1> : tensor<2xi64>
  %result0, %result1 = "pphlo.case"(%index) ({
    pphlo.return %result_branch0, %result_branch0 : tensor<2xi64>, tensor<2xi64>
...
func.func @case_out_of_bound_index_default() {
  %index = arith.constant dense<2> : tensor<i32>
  %result_branch0 = arith.constant dense<0> : tensor<2xi64>
  %result_branch1 = arith.constant dense<1> : tensor<2xi64>
  %result0, %result1 = "pphlo.case"(%index) ({
    pphlo.return %result_branch0, %result_branch0 : tensor<2xi64>, tensor<2xi64>
...
func.func @case_out_of_bound_index_default() {
  ...
  %1 = arith.constant dense<0> : tensor<2xi64>
  %2 = arith.constant dense<1> : tensor<2xi64>
  ...
  %expected = arith.constant dense<[1, 1]> : tensor<2xi64>
  pphlo.custom_call @expect_eq(%expected, %result0) : (tensor<2xi64>, tensor<2x!pphlo.secret<i64>>)->()
