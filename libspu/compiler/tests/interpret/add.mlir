...
func.func @add_op_test_i8_i8_pp() {
   ...
   %3 = arith.constant dense<[-128, 0, 16, -18, 127]> : tensor<5xi8>
...
func.func @add_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<[-128, 0, 16, -18, 127]> : tensor<5xi8>
...
func.func @add_op_test_ui8_ui8_pp() {
   ...
   %3 = arith.constant dense<[255, 32]> : tensor<2xui8>
...
func.func @add_op_test_ui8_ui8_ss() {
   ...
   %5 = arith.constant dense<[255, 32]> : tensor<2xui8>
...
func.func @add_op_test_i16_i16_pp() {
   ...
   %3 = arith.constant dense<[-32768, 0, 256, -258, 32767]> : tensor<5xi16>
...
func.func @add_op_test_i16_i16_ss() {
   ...
   %5 = arith.constant dense<[-32768, 0, 256, -258, 32767]> : tensor<5xi16>
...
func.func @add_op_test_ui16_ui16_pp() {
   ...
   %3 = arith.constant dense<[65535, 512]> : tensor<2xui16>
...
func.func @add_op_test_ui16_ui16_ss() {
   ...
   %5 = arith.constant dense<[65535, 512]> : tensor<2xui16>
...
func.func @add_op_test_i32_i32_pp() {
   ...
   %3 = arith.constant dense<[-2147483648, 0, 65536, -65538, 2147483647]> : tensor<5xi32>
...
func.func @add_op_test_i32_i32_ss() {
   ...
   %5 = arith.constant dense<[-2147483648, 0, 65536, -65538, 2147483647]> : tensor<5xi32>
...
func.func @add_op_test_ui32_ui32_pp() {
   ...
   %3 = arith.constant dense<[4294967295, 131072]> : tensor<2xui32>
...
func.func @add_op_test_ui32_ui32_ss() {
   ...
   %5 = arith.constant dense<[4294967295, 131072]> : tensor<2xui32>
...
func.func @add_op_test_i64_i64_pp() {
   ...
   %3 = arith.constant dense<[-9223372036854775808, 0, 4294967296, -4294967298, 9223372036854775807]> : tensor<5xi64>
...
func.func @add_op_test_i64_i64_ss() {
   ...
   %5 = arith.constant dense<[-9223372036854775808, 0, 4294967296, -4294967298, 9223372036854775807]> : tensor<5xi64>
...
func.func @add_op_test_ui64_ui64_pp() {
   ...
   %3 = arith.constant dense<[18446744073709551615, 8589934592]> : tensor<2xui64>
...
func.func @add_op_test_ui64_ui64_ss() {
   ...
   %5 = arith.constant dense<[18446744073709551615, 8589934592]> : tensor<2xui64>
...
func.func @add_op_test_f16_f16_pp() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 8.000000e+00, 8.750000e-01, 3.999020e-01, 6.281250e+00]> : tensor<5xf16>
...
func.func @add_op_test_f16_f16_ss() {
   ...
   %5 = arith.constant dense<[0.000000e+00, 8.000000e+00, 8.750000e-01, 3.999020e-01, 6.281250e+00]> : tensor<5xf16>
...
func.func @add_op_test_f32_f32_pp() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 8.000000e+00, 8.750000e-01, 4.000000e-01, 6.28318548]> : tensor<5xf32>
...
func.func @add_op_test_f32_f32_ss() {
   ...
   %5 = arith.constant dense<[0.000000e+00, 8.000000e+00, 8.750000e-01, 4.000000e-01, 6.28318548]> : tensor<5xf32>
...
func.func @add_op_test_f64_f64_pp() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 8.000000e+00, 8.750000e-01, 4.000000e-01, 6.2831853071795862]> : tensor<5xf64>
...
func.func @add_op_test_f64_f64_ss() {
   ...
   %5 = arith.constant dense<[0.000000e+00, 8.000000e+00, 8.750000e-01, 4.000000e-01, 6.2831853071795862]> : tensor<5xf64>
...
func.func @add_op_test_i8_i8_pp() {
   %0 = arith.constant dense<2> : tensor<i8>
   %1 = arith.constant dense<3> : tensor<i8>
   %2 = pphlo.add %0,%1 : (tensor<i8>,tensor<i8>)->tensor<i8>
   %3 = arith.constant dense<5> : tensor<i8>
...
func.func @add_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<5> : tensor<i8>
   pphlo.custom_call @expect_eq(%5, %4) : (tensor<i8>, tensor<!pphlo.secret<i8>>)->()
   func.return
}
...
func.func @add_op_test_i8_i8_pp() {
   %0 = arith.constant dense<2> : tensor<2x0x3xi8>
   %1 = arith.constant dense<3> : tensor<2x0x3xi8>
   %2 = pphlo.add %0,%1 : (tensor<2x0x3xi8>,tensor<2x0x3xi8>)->tensor<2x0x3xi8>
   %3 = arith.constant dense<> : tensor<2x0x3xi8>
...
func.func @add_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<> : tensor<2x0x3xi8>
   pphlo.custom_call @expect_eq(%5, %4) : (tensor<2x0x3xi8>, tensor<2x0x3x!pphlo.secret<i8>>)->()
   func.return
}
