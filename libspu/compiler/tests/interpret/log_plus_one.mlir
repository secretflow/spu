...
func.func @log_plus_one_op_test_f64_f64_p() {
   %0 = arith.constant dense<[0.0, -0.999, 7.0, 6.38905621, 15.0]> : tensor<5xf64>
   %1 = pphlo.log_plus_one %0 : (tensor<5xf64>)->tensor<5xf64>
   %2 = arith.constant dense<[0.0, -6.90776825, 2.07944155, 2.0, 2.77258873]> : tensor<5xf64>
...
func.func @log_plus_one_op_test_f64_f64_s() {
   ...
   %3 = arith.constant dense<[0.0, -6.90776825, 2.07944155, 2.0, 2.77258873]> : tensor<5xf64>
