...
func.func @tanh_op_test_f16_f16_p() {
   ...
   %2 = arith.constant dense<[0.000000e+00, 7.617180e-01, 1.243290e-01, 9.967040e-02, 9.960930e-01]> : tensor<5xf16>
...
func.func @tanh_op_test_f16_f16_s() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 7.617180e-01, 1.243290e-01, 9.967040e-02, 9.960930e-01]> : tensor<5xf16>
...
func.func @tanh_op_test_f32_f32_p() {
   ...
   %2 = arith.constant dense<[0.000000e+00, 0.761594176, 1.243530e-01, 0.0996679961, 0.996272087]> : tensor<5xf32>
...
func.func @tanh_op_test_f32_f32_s() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 0.761594176, 1.243530e-01, 0.0996679961, 0.996272087]> : tensor<5xf32>
...
func.func @tanh_op_test_f64_f64_p() {
   ...
   %2 = arith.constant dense<[0.000000e+00, 0.76159415595576485, 0.12435300177159619, 0.099667994624955819, 0.99627207622074998]> : tensor<5xf64>
...
func.func @tanh_op_test_f64_f64_s() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 0.76159415595576485, 0.12435300177159619, 0.099667994624955819, 0.99627207622074998]> : tensor<5xf64>
