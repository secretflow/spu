...
func.func @rsqrt_op_test_f64_f64_p() {
   %0 = arith.constant dense<[[1.0, 4.0], [9.0, 25.0]]> : tensor<2x2xf64>
   %1 = pphlo.rsqrt %0 : (tensor<2x2xf64>)->tensor<2x2xf64>
   %2 = arith.constant dense<[[1.000000e+00, 5.000000e-01], [0.33333333333333331, 2.000000e-01]]> : tensor<2x2xf64>
...
func.func @rsqrt_op_test_f64_f64_s() {
   ...
   %3 = arith.constant dense<[[1.000000e+00, 5.000000e-01], [0.33333333333333331, 2.000000e-01]]> : tensor<2x2xf64>
