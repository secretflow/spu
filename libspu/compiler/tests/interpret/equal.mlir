...
func.func @equal_op_test_i64_i1_ss() {
   ...
   %5 = arith.constant dense<true> : tensor<i1>
   pphlo.custom_call @expect_eq(%5, %4) : (tensor<i1>, tensor<!pphlo.secret<i1>>)->()
   func.return
}
...
func.func @equal_op_test_ui64_i1_pp() {
   %0 = arith.constant dense<0> : tensor<ui64>
   %1 = arith.constant dense<0> : tensor<ui64>
...
func.func @equal_op_test_i1_i1_pp() {
   ...
   %1 = arith.constant dense<true> : tensor<i1>
...
func.func @equal_op_test_i1_i1_pp() {
   ...
   %3 = arith.constant dense<[true, false, false, true]> : tensor<4xi1>
...
func.func @equal_op_test_i1_i1_ss() {
   ...
   %5 = arith.constant dense<[true, false, false, true]> : tensor<4xi1>
