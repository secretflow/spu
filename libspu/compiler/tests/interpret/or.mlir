...
func.func @or_op_test_i8_i8_pp() {
   ...
   %3 = arith.constant dense<[127, -1, -128]> : tensor<3xi8>
...
func.func @or_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<[127, -1, -128]> : tensor<3xi8>
...
func.func @or_op_test_ui8_ui8_pp() {
   ...
   %3 = arith.constant dense<[255, 255, 255]> : tensor<3xui8>
...
func.func @or_op_test_ui8_ui8_ss() {
   ...
   %5 = arith.constant dense<[255, 255, 255]> : tensor<3xui8>
...
func.func @or_op_test_i16_i16_pp() {
   ...
   %3 = arith.constant dense<[32767, -1, -32768]> : tensor<3xi16>
...
func.func @or_op_test_i16_i16_ss() {
   ...
   %5 = arith.constant dense<[32767, -1, -32768]> : tensor<3xi16>
...
func.func @or_op_test_ui16_ui16_pp() {
   ...
   %3 = arith.constant dense<[65535, 65535, 65535]> : tensor<3xui16>
...
func.func @or_op_test_ui16_ui16_ss() {
   ...
   %5 = arith.constant dense<[65535, 65535, 65535]> : tensor<3xui16>
...
func.func @or_op_test_i32_i32_pp() {
   ...
   %3 = arith.constant dense<[2147483647, -1, -2147483648]> : tensor<3xi32>
...
func.func @or_op_test_i32_i32_ss() {
   ...
   %5 = arith.constant dense<[2147483647, -1, -2147483648]> : tensor<3xi32>
...
func.func @or_op_test_ui32_ui32_pp() {
   ...
   %3 = arith.constant dense<[4294967295, 4294967295, 4294967295]> : tensor<3xui32>
...
func.func @or_op_test_ui32_ui32_ss() {
   ...
   %5 = arith.constant dense<[4294967295, 4294967295, 4294967295]> : tensor<3xui32>
...
func.func @or_op_test_i64_i64_pp() {
   ...
   %3 = arith.constant dense<[9223372036854775807, -1, -9223372036854775808]> : tensor<3xi64>
...
func.func @or_op_test_i64_i64_ss() {
   ...
   %5 = arith.constant dense<[9223372036854775807, -1, -9223372036854775808]> : tensor<3xi64>
...
func.func @or_op_test_ui64_ui64_pp() {
   ...
   %3 = arith.constant dense<[18446744073709551615, 18446744073709551615, 18446744073709551615]> : tensor<3xui64>
...
func.func @or_op_test_ui64_ui64_ss() {
   ...
   %5 = arith.constant dense<[18446744073709551615, 18446744073709551615, 18446744073709551615]> : tensor<3xui64>
...
func.func @or_op_test_i1_i1_pp() {
   ...
   %1 = arith.constant dense<[false, true]> : tensor<2xi1>
   %2 = pphlo.or %0,%1 : (tensor<2xi1>,tensor<2xi1>)->tensor<2xi1>
   %3 = arith.constant dense<[true, true]> : tensor<2xi1>
   pphlo.custom_call @expect_eq(%2, %3) : (tensor<2xi1>, tensor<2xi1>)->()
   func.return
}
...
func.func @or_op_test_i1_i1_ss() {
   ...
   %3 = pphlo.convert %1 : (tensor<2xi1>)->tensor<2x!pphlo.secret<i1>>
   %4 = pphlo.or %2, %3 : (tensor<2x!pphlo.secret<i1>>,tensor<2x!pphlo.secret<i1>>)->tensor<2x!pphlo.secret<i1>>
   %5 = arith.constant dense<[true, true]> : tensor<2xi1>
   pphlo.custom_call @expect_eq(%5, %4) : (tensor<2xi1>, tensor<2x!pphlo.secret<i1>>)->()
   func.return
}
