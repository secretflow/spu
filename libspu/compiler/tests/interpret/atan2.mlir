...
func.func @atan2_op_test_f64_f64_pp() {
   %0 = arith.constant dense<[0.0, 1.0, -1.0]> : tensor<3xf64>
   %1 = arith.constant dense<[0.0, 0.0, 0.0]> : tensor<3xf64>
   %2 = pphlo.atan2 %0,%1 : (tensor<3xf64>,tensor<3xf64>)->tensor<3xf64>
   %3 = arith.constant dense<[0.0, 1.5707963267948966, -1.5707963267948966]> : tensor<3xf64>
...
func.func @atan2_op_test_f64_f64_ss() {
   ...
   %5 = arith.constant dense<[0.0, 1.5707963267948966, -1.5707963267948966]> : tensor<3xf64>
   pphlo.custom_call @expect_almost_eq(%5, %4) : (tensor<3xf64>, tensor<3x!pphlo.secret<f64>>)->()
   func.return
}
