...
func.func @sine_op_test_f16_f16_p() {
   ...
   %2 = arith.constant dense<[0.000000e+00, 8.413080e-01, 1.246950e-01, 9.979240e-02, 9.675020e-04]> : tensor<5xf16>
...
func.func @sine_op_test_f16_f16_s() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 8.413080e-01, 1.246950e-01, 9.979240e-02, 9.675020e-04]> : tensor<5xf16>
...
func.func @sine_op_test_f32_f32_p() {
   ...
   %2 = arith.constant dense<[0.000000e+00, 0.841470957, 0.12467473, 0.0998334214, -8.74227765E-8]> : tensor<5xf32>
...
func.func @sine_op_test_f32_f32_s() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 0.841470957, 0.12467473, 0.0998334214, -8.74227765E-8]> : tensor<5xf32>
...
func.func @sine_op_test_f64_f64_p() {
   ...
   %2 = arith.constant dense<[0.000000e+00, 0.8414709848078965, 0.12467473338522769, 0.099833416646828154, 1.2246467991473532E-16]> : tensor<5xf64>
...
func.func @sine_op_test_f64_f64_s() {
   ...
   %3 = arith.constant dense<[0.000000e+00, 0.8414709848078965, 0.12467473338522769, 0.099833416646828154, 1.2246467991473532E-16]> : tensor<5xf64>
