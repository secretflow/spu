...
func.func @abs_op_test_i64_i64_p() {
   %0 = arith.constant dense<[-2, 0, 2]> : tensor<3xi64>
   %1 = pphlo.abs %0 : (tensor<3xi64>)->tensor<3xi64>
   %2 = arith.constant dense<[ 2, 0, 2]> : tensor<3xi64>
...
func.func @abs_op_test_i64_i64_s() {
   ...
   %3 = arith.constant dense<[ 2, 0, 2]> : tensor<3xi64>
...
func.func @abs_op_test_f64_f64_p() {
   %0 = arith.constant dense<[23.1, -23.1, 0.0]> : tensor<3xf64>
   %1 = pphlo.abs %0 : (tensor<3xf64>)->tensor<3xf64>
   %2 = arith.constant dense<[23.1,  23.1, 0.0]> : tensor<3xf64>
...
func.func @abs_op_test_f64_f64_s() {
   ...
   %3 = arith.constant dense<[23.1,  23.1, 0.0]> : tensor<3xf64>
