...
func.func @round_nearest_even_op_test_f64_f64_p() {
   %0 = arith.constant dense<[-2.5, 0.4, 0.5, 0.6, 2.5]> : tensor<5xf64>
   %1 = pphlo.round_nearest_even %0 : (tensor<5xf64>)->tensor<5xf64>
   %2 = arith.constant dense<[-2.0, 0.0, 0.0, 1.0, 2.0]> : tensor<5xf64>
...
func.func @round_nearest_even_op_test_f64_f64_s() {
   %0 = arith.constant dense<[-2.5, 0.4, 0.5, 0.6, 2.5]> : tensor<5xf64>
   %1 = pphlo.convert %0 : (tensor<5xf64>)->tensor<5x!pphlo.secret<f64>>
   %2 = pphlo.round_nearest_even %1 : (tensor<5x!pphlo.secret<f64>>)->tensor<5x!pphlo.secret<f64>>
   %3 = arith.constant dense<[-2.0, 0.0, 0.0, 1.0, 2.0]> : tensor<5xf64>
