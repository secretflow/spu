...
func.func @minimum_op_test_i8_i8_pp() {
   ...
   %3 = arith.constant dense<[-128, -1, 8, -9, 0]> : tensor<5xi8>
...
func.func @minimum_op_test_i8_i8_ss() {
   ...
   %5 = arith.constant dense<[-128, -1, 8, -9, 0]> : tensor<5xi8>
...
func.func @minimum_op_test_ui8_ui8_pp() {
   ...
   %3 = arith.constant dense<[0, 16]> : tensor<2xui8>
...
func.func @minimum_op_test_ui8_ui8_ss() {
   ...
   %5 = arith.constant dense<[0, 16]> : tensor<2xui8>
...
func.func @minimum_op_test_i16_i16_pp() {
   ...
   %3 = arith.constant dense<[-32768, -1, 128, -129, 0]> : tensor<5xi16>
...
func.func @minimum_op_test_i16_i16_ss() {
   ...
   %5 = arith.constant dense<[-32768, -1, 128, -129, 0]> : tensor<5xi16>
...
func.func @minimum_op_test_ui16_ui16_pp() {
   ...
   %3 = arith.constant dense<[0, 256]> : tensor<2xui16>
...
func.func @minimum_op_test_ui16_ui16_ss() {
   ...
   %5 = arith.constant dense<[0, 256]> : tensor<2xui16>
...
func.func @minimum_op_test_i32_i32_pp() {
   ...
   %3 = arith.constant dense<[-2147483648, -1, 32768, -32769, 0]> : tensor<5xi32>
...
func.func @minimum_op_test_i32_i32_ss() {
   ...
   %5 = arith.constant dense<[-2147483648, -1, 32768, -32769, 0]> : tensor<5xi32>
...
func.func @minimum_op_test_ui32_ui32_pp() {
   ...
   %3 = arith.constant dense<[0, 65536]> : tensor<2xui32>
...
func.func @minimum_op_test_ui32_ui32_ss() {
   ...
   %5 = arith.constant dense<[0, 65536]> : tensor<2xui32>
...
func.func @minimum_op_test_i64_i64_pp() {
   ...
   %1 = arith.constant dense<[-223372036854775808, -1, 2147483648, -2147483649, 223372036854775807]> : tensor<5xi64>
   %2 = pphlo.minimum %0,%1 : (tensor<5xi64>,tensor<5xi64>)->tensor<5xi64>
   %3 = arith.constant dense<[-223372036854775808, -1, 2147483648, -2147483649, 0]> : tensor<5xi64>
...
func.func @minimum_op_test_i64_i64_ss() {
   ...
   %5 = arith.constant dense<[-223372036854775808, -1, 2147483648, -2147483649, 0]> : tensor<5xi64>
...
func.func @minimum_op_test_ui64_ui64_pp() {
   ...
   %3 = arith.constant dense<[0, 4294967296]> : tensor<2xui64>
...
func.func @minimum_op_test_ui64_ui64_ss() {
   ...
   %5 = arith.constant dense<[0, 4294967296]> : tensor<2xui64>
