...
func.func @not_op_test_i8_i8_p() {
   %0 = arith.constant dense<[127, -128, 0]> : tensor<3xi8>
   %1 = pphlo.not %0 : (tensor<3xi8>)->tensor<3xi8>
   %2 = arith.constant dense<[-128, 127, -1]> : tensor<3xi8>
...
func.func @not_op_test_i8_i8_s() {
   ...
   %3 = arith.constant dense<[-128, 127, -1]> : tensor<3xi8>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<3xi8>, tensor<3x!pphlo.secret<i8>>)->()
   func.return
}
...
func.func @not_op_test_ui8_ui8_p() {
   ...
   %2 = arith.constant dense<[255, 128, 0]> : tensor<3xui8>
...
func.func @not_op_test_ui8_ui8_s() {
   ...
   %3 = arith.constant dense<[255, 128, 0]> : tensor<3xui8>
...
func.func @not_op_test_i16_i16_p() {
   %0 = arith.constant dense<[32767, -32768, 0]> : tensor<3xi16>
   %1 = pphlo.not %0 : (tensor<3xi16>)->tensor<3xi16>
   %2 = arith.constant dense<[-32768, 32767, -1]> : tensor<3xi16>
...
func.func @not_op_test_i16_i16_s() {
   ...
   %3 = arith.constant dense<[-32768, 32767, -1]> : tensor<3xi16>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<3xi16>, tensor<3x!pphlo.secret<i16>>)->()
   func.return
}
...
func.func @not_op_test_ui16_ui16_p() {
   ...
   %2 = arith.constant dense<[65535, 32768, 0]> : tensor<3xui16>
...
func.func @not_op_test_ui16_ui16_s() {
   ...
   %3 = arith.constant dense<[65535, 32768, 0]> : tensor<3xui16>
...
func.func @not_op_test_i32_i32_p() {
   %0 = arith.constant dense<[2147483647, -2147483648, 0]> : tensor<3xi32>
   %1 = pphlo.not %0 : (tensor<3xi32>)->tensor<3xi32>
   %2 = arith.constant dense<[-2147483648, 2147483647, -1]> : tensor<3xi32>
...
func.func @not_op_test_i32_i32_s() {
   ...
   %3 = arith.constant dense<[-2147483648, 2147483647, -1]> : tensor<3xi32>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<3xi32>, tensor<3x!pphlo.secret<i32>>)->()
   func.return
}
...
func.func @not_op_test_ui32_ui32_p() {
   ...
   %2 = arith.constant dense<[4294967295, 2147483648, 0]> : tensor<3xui32>
...
func.func @not_op_test_ui32_ui32_s() {
   ...
   %3 = arith.constant dense<[4294967295, 2147483648, 0]> : tensor<3xui32>
...
func.func @not_op_test_i64_i64_p() {
   %0 = arith.constant dense<[9223372036854775807, -9223372036854775808, 0]> : tensor<3xi64>
   %1 = pphlo.not %0 : (tensor<3xi64>)->tensor<3xi64>
   %2 = arith.constant dense<[-9223372036854775808, 9223372036854775807, -1]> : tensor<3xi64>
...
func.func @not_op_test_i64_i64_s() {
   ...
   %3 = arith.constant dense<[-9223372036854775808, 9223372036854775807, -1]> : tensor<3xi64>
...
func.func @not_op_test_ui64_ui64_p() {
   ...
   %2 = arith.constant dense<[18446744073709551615, 9223372036854775808, 0]> : tensor<3xui64>
...
func.func @not_op_test_ui64_ui64_s() {
   ...
   %3 = arith.constant dense<[18446744073709551615, 9223372036854775808, 0]> : tensor<3xui64>
...
func.func @not_op_test_i1_i1_p() {
   %0 = arith.constant dense<[false, true]> : tensor<2xi1>
   %1 = pphlo.not %0 : (tensor<2xi1>)->tensor<2xi1>
   %2 = arith.constant dense<[true, false]> : tensor<2xi1>
...
func.func @not_op_test_i1_i1_s() {
   ...
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<2xi1>, tensor<2x!pphlo.secret<i1>>)->()
   func.return
}
...
func.func @not_op_test_i1_i1_s() {
   ...
   %3 = arith.constant dense<true> : tensor<i1>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<i1>, tensor<!pphlo.secret<i1>>)->()
   func.return
}
...
func.func @not_op_test_i1_i1_s() {
   ...
   %1 = pphlo.convert %0 : (tensor<i1>)->tensor<!pphlo.secret<i1>>
   %2 = pphlo.not %1 : (tensor<!pphlo.secret<i1>>)->tensor<!pphlo.secret<i1>>
   %3 = arith.constant dense<false> : tensor<i1>
   pphlo.custom_call @expect_eq(%3, %2) : (tensor<i1>, tensor<!pphlo.secret<i1>>)->()
   func.return
}
