...
func.func @main(%arg0: tensor<16xf32>) -> (tensor<1024x16xf32>) {
    // CHECK: %0 = "pphlo.broadcast"(%arg0) {broadcast_dimensions = array<i64: 1>} : (tensor<16xf32>) -> tensor<1024x16xf32>
...
func.func @main(%arg0: tensor<1x16xf32>) -> (tensor<16x1xf32>) {
    // CHECK: %0 = "pphlo.transpose"(%arg0) {permutation = array<i64: 1, 0>} : (tensor<1x16xf32>) -> tensor<16x1xf32>
...
func.func @main(%arg0: tensor<16x1xf32>) -> (tensor<16x2xf32>) {
    // CHECK: %0 = "pphlo.concatenate"(%arg0, %arg0) {dimension = 1 : i64} : (tensor<16x1xf32>, tensor<16x1xf32>) -> tensor<16x2xf32>
...
func.func @main(%arg4: tensor<3x4xi32>) -> (tensor<1x2xi32>) {
    // CHECK: %0 = "pphlo.slice"(%arg0) {limit_indices = array<i64: 2, 4>, start_indices = array<i64: 1, 0>, strides = array<i64: 1, 2>} : (tensor<3x4xi32>) -> tensor<1x2xi32>
