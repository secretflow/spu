...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.sqrt"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.negate"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.exponential"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.log_plus_one"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.floor"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.ceil"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.abs"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xf32>) -> (tensor<2x2xf32>) {
    // CHECK: "pphlo.logistic"(%arg0) : (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @main(%arg0: tensor<2x2xi32>) -> (tensor<2x2xi32>) {
    // CHECK: "pphlo.not"(%arg0) : (tensor<2x2xi32>) -> tensor<2x2xi32>
