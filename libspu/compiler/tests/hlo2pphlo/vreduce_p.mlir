...
func.func @main(%arg0: tensor<1024x1xf32>, %arg1: tensor<1024x1xf32>) -> (tensor<1024xf32>, tensor<1024xf32>) {
    ...
    // CHECK: %1:2 = pphlo.reduce(%arg0 init: %0), (%arg1 init: %0) across dimensions = [1] : (tensor<1024x1xf32>, tensor<1024x1xf32>, tensor<f32>, tensor<f32>) -> (tensor<1024xf32>, tensor<1024xf32>)
    // CHECK:     reducer(%arg2: tensor<f32>, %arg4: tensor<f32>) (%arg3: tensor<f32>, %arg5: tensor<f32>) {
    // CHECK:        %2 = pphlo.add %arg2, %arg3 : tensor<f32>
    // CHECK:        %3 = pphlo.add %arg4, %arg5 : tensor<f32>
