...
func.func @main(%arg0: tensor<1024x1xf32>, %arg1: tensor<1024x1xf32>) -> (tensor<1024xf32>, tensor<1024xf32>) {
    ...
    // CHECK: %3:2 = "pphlo.reduce"(%arg0, %arg1, %1, %2) ({
    // CHECK:    ^bb0(%arg2: tensor<!pphlo.secret<f32>>, %arg3: tensor<!pphlo.secret<f32>>, %arg4: tensor<!pphlo.secret<f32>>, %arg5: tensor<!pphlo.secret<f32>>):
    // CHECK:        %4 = "pphlo.add"(%arg2, %arg4) : (tensor<!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>) -> tensor<!pphlo.secret<f32>>
    // CHECK:        %5 = "pphlo.add"(%arg3, %arg5) : (tensor<!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>) -> tensor<!pphlo.secret<f32>>
    // CHECK:        "pphlo.return"(%4, %5) : (tensor<!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>) -> ()
    // CHECK: }) {dimensions = array<i64: 1>} : (tensor<1024x1x!pphlo.secret<f32>>, tensor<1024x1x!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>, tensor<!pphlo.secret<f32>>) -> (tensor<1024x!pphlo.secret<f32>>, tensor<1024x!pphlo.secret<f32>>)
