...
class AShrTy : public TypeImpl<AShrTy, RingTy, Secret, AShare> {
 ...
 public:
  using Base::Base;
  static std::string_view getStaticId() { return "albo.AShr"; }
...
class BShrTy : public TypeImpl<BShrTy, TypeObject, Secret, BShare> {
 ...
 public:
  ...
  static std::string_view getStaticId() { return "albo.BShr"; }
...
class PShrTy : public TypeImpl<PShrTy, RingTy, Secret, PShare> {
 ...
 public:
  using Base::Base;
  static std::string_view getStaticId() { return "albo.PShr"; }
