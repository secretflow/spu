...
func.func @mul(%arg0: tensor<2x2x!pphlo.pub<f32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<f32>>) {
...
func.func @dot(%arg0: tensor<2x2x!pphlo.pub<f32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<f32>>) {
...
func.func @dot_general(%arg0: tensor<3x1x4x!pphlo.pub<f32>>, %arg1: tensor<3x4x5x!pphlo.pub<i32>>) -> (tensor<3x5x!pphlo.pub<f32>>) {
...
func.func @dot_negative(%arg0: tensor<2x2x!pphlo.pub<f32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<i32>>) {
