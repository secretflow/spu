...
func.func @ne(%arg0: tensor<2x2x!pphlo.pub<i32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<i1>>) {
...
func.func @le(%arg0: tensor<2x2x!pphlo.pub<i32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<i1>>) {
...
func.func @ge(%arg0: tensor<2x2x!pphlo.pub<i32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<i1>>) {
...
func.func @all(%arg0: tensor<2x2x!pphlo.pub<i32>>, %arg1: tensor<2x2x!pphlo.pub<i32>>) -> (tensor<2x2x!pphlo.pub<i1>>, tensor<2x2x!pphlo.pub<i1>>, tensor<2x2x!pphlo.pub<i1>>, tensor<2x2x!pphlo.pub<i1>>, tensor<2x2x!pphlo.pub<i1>>, tensor<2x2x!pphlo.pub<i1>>) {
    //CHECK: %0 = "pphlo.equal"(%arg0, %arg1) : (tensor<2x2x!pphlo.pub<i32>>, tensor<2x2x!pphlo.pub<i32>>) -> tensor<2x2x!pphlo.pub<i1>>
    //CHECK: %1 = "pphlo.not"(%0) : (tensor<2x2x!pphlo.pub<i1>>) -> tensor<2x2x!pphlo.pub<i1>>
