...
class IEcdhOprf {
 public:
  ...
  virtual size_t GetCompareLength() const { return kEccKeySize; }
...
class IEcdhOprfServer : public IEcdhOprf {
 public:
  ...
  // set private_key
  IEcdhOprfServer(yasl::ByteContainerView private_key) {
   ...
   */
  virtual std::string FullEvaluate(absl::string_view input) const = 0;
