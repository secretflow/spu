...
def invperm(in1, in2):
    ...
    return _invperm_prim.bind(in1, in2)
...
def _invperm_lowering(ctx, in1, in2):
...
def _invperm_jvp(args, tangents):
...
# *********************************************
_invperm_prim = core.Primitive("invperm")
# Change this to True if there are more than 1 output
_invperm_prim.multiple_results = False
_invperm_prim.def_impl(partial(xla.apply_primitive, _invperm_prim))
_invperm_prim.def_abstract_eval(_invperm_abstract)

mlir.register_lowering(_invperm_prim, _invperm_lowering)

# Connect the JVP and batching rules
ad.primitive_jvps[_invperm_prim] = _invperm_jvp
batching.primitive_batchers[_invperm_prim] = _invperm_batch
