...
def _com_github_pybind11_bazel():
    maybe(
        ...
        strip_prefix = "pybind11_bazel-3946bd0164dc97a154b3136df180f3743cd2cbae",
        urls = [
            "https://github.com/pybind/pybind11_bazel/archive/3946bd0164dc97a154b3136df180f3743cd2cbae.zip",
        ],
    )
